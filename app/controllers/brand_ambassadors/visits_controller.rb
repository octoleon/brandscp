class BrandAmbassadors::VisitsController < FilteredController
  ...
  def permitted_params
    params.permit(brand_ambassadors_visit: [:visit_type, :campaign_id, :brand,
                                            :brand_portfolio, :area_id, :city, :description,
  ...
  def permitted_search_params
    [:page, :sorting, :sorting_dir, :per_page, start_date: [], brand: [],
     brand_portfolio: [], end_date: [], campaign: [], area: [], user: [], city: []]
  end
