  ...
  * *trends_by_week*: returns information about the performance of the venue on each different day of the week.
  ...
  description <<-EOS
    ...
    * For photos uploaded from the app:
      ...
      * *type*: the photo's type. In this case it should be 'app'
  ...
  [
      {
          ...
          "active": true,
          "file_small": "http://s3.amazonaws.com/app-dev/attached_assets/files/000/000/014/small/Folder.jpg?1378940624",
          "file_medium": "http://s3.amazonaws.com/app-dev/attached_assets/files/000/000/014/medium/Folder.jpg?1378940624",
          "file_original": "http://s3.amazonaws.com/app-dev/attached_assets/files/000/000/014/original/Folder.jpg?1378940624",
          "type": "app"
      },
      {
  ...
  description <<-EOS
    ...
    * For comments uploaded from the app:
      ...
      * *type:* the comment's type. In this case it should be 'app'
