    ...
    (CSV.generate do |csv|
      ...
      each_collection_item do |event|
        csv << [
          ...
          event.place_td_linx_code, event.place_name, event.place_address,  event.place_city, event.place_state_name,event.place_zipcode, event.country, event.start_date, event.end_date,
