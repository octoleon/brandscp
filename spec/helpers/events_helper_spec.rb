...
describe EventsHelper, type: :helper do
  describe 'describe_filters' do
    ...
    describe 'without params' do
      it { is_expected.to eql '<span class="results-count">100 events found for: </span>' }

      describe 'with just one result' do
        before { allow(helper).to receive(:collection_count).and_return(1) }
        it { is_expected.to eql '<span class="results-count">1 event found for: </span>' }
      end
    end
    ...
    describe 'with one campaign selected' do
      ...
      it do
        is_expected.to eql(
          '<span class="results-count">100 events found for: </span> '\
    ...
    describe 'for visits' do
      ...
      describe 'without params' do
        it { is_expected.to eql '<span class="results-count">100 visits found for: </span>' }
      end
    end
  end
end
