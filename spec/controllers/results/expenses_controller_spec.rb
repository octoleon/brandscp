  ...
  describe "GET 'list_export'", :search, :inline_jobs do
    ...
    it 'should return an empty xls with the correct headers' do
      ...
      expect(export.reload).to have_rows([
        ['CAMPAIGN NAME',  'AREAS', 'TD LINX CODE', 'VENUE NAME', 'ADDRESS', 'CITY', 'STATE', 'ZIP', 'COUNTRY', 'EVENT START DATE', 'EVENT END DATE',
    ...
    it 'should return an empty xls with the correct headers' do
      create(:approved_event, campaign: campaign,
              ...
              start_time: '8:00pm', end_time: '11:00pm', place: create(:place, name: 'Place 1', td_linx_code: '29393'),
              submitted_at: submitted_at, approved_at: approved_at, description: 'Approved Event with TD Linx Code',
              event_expenses: [
                build(:event_expense, category: 'Entertainment', description: 'First Event Description', amount: 10, created_at: created_at, updated_at: updated_at)])

      create(:approved_event, campaign: campaign,
              start_date: '08/20/2013', end_date: '08/20/2013',
              start_time: '9:00am', end_time: '10:00am', place: create(:place, name: 'Place 2', td_linx_code: '29999'),
              event_expenses: [
                build(:event_expense, category: 'Uncategorized', description: 'Second Event Description', amount: 20, created_at: created_at, updated_at: updated_at)])
      ...
      expect(export.reload).to have_rows([
        ...
        ['Test Campaign FY01','', '="29999"', 'Place 2', 'Place 2, 11 Main St., New York City, NY, 12345', 'New York City', 'NY', '12345', 'US',
         '2013-08-20 09:00', '2013-08-20 10:00', '2014-07-02 10:00', 'Test User', '2015-07-01 10:00', 'Test User', '20.0', nil, '20.0'],
        ['Test Campaign FY01','','="29393"', 'Place 1', 'Place 1, 11 Main St., New York City, NY, 12345','New York City', 'NY', '12345', 'US',
