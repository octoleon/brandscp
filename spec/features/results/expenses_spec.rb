  ...
  feature 'export', search: true do
    ...
    before do
      create(:approved_event, campaign: campaign1,
                              ...
                              start_time: '8:00pm', end_time: '11:00pm', place: create(:place, name: 'Place 1', td_linx_code: '30001'),
                              submitted_at: submitted_at, approved_at: approved_at,
                              event_expenses: [
                                build(:event_expense, amount: 10, brand_id: brand.id, created_at: created_at, updated_at: updated_at, description: 'First expense')])

      create(:approved_event, campaign: campaign2,
                              start_date: '08/25/2013', end_date: '08/25/2013',
                              start_time: '9:00am', end_time: '10:00am', place: create(:place, name: 'Place 2' , td_linx_code: '30002'),
                              event_expenses: [
                                build(:event_expense, amount: 20, created_at: created_at, updated_at: updated_at,description: 'Second expense')])
    ...
    scenario 'should be able to export as CSV' do
      ...
      expect(ListExport.last).to have_rows([
        ...
        ['First Campaign', '', '="30001"', 'Place 1', 'Place 1, 11 Main St., New York City, NY, 12345', 'New York City', 'NY', '12345', 'US', '2013-08-21 20:00',
         '2013-08-21 23:00', '2014-07-02 10:00', 'Test User', '2015-07-01 10:00', 'Test User', '10.0', '10.0'],
        ['Second Campaign', '', '="30002"', 'Place 2', 'Place 2, 11 Main St., New York City, NY, 12345','New York City', 'NY', '12345', 'US', '2013-08-25 09:00',
