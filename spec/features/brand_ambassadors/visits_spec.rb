...
feature 'Brand Ambassadors Visits' do
  ...
  let(:brand1) { create(:brand, name: 'Brand 1', company: company, active: true) }
  let(:brand2) { create(:brand, name: 'Brand 2', company: company, active: true) }
  ...
  shared_examples_for 'a user that can filter the list of visits' do
    ...
    let(:brand_portfolio) { create(:brand_portfolio, name: 'Brand Porfolio 1', company: company) }
    ...
    scenario 'should allow filter visits and see the correct message' do
      Timecop.travel(today) do
        ...
        company_user.campaigns << [campaign, campaign1, campaign2]
        event1.users << another_user
        campaign1.brands << brand1
        campaign2.brands << brand2
        campaign2.brands << brand1
        campaign.brands << brand1
        company_user.brands << [brand1, brand2]
        brand_portfolio.brands << brand1
        ...
        add_filter 'BRANDS', 'Brand 1'

        expect(page).to have_content('2 visits found for: Today To The Future Brand 1')
        ...
        remove_filter 'Brand 1'

        add_filter 'BRANDS', 'Brand Porfolio 1'

        expect(page).to have_content('2 visits found for: Today To The Future Brand Porfolio 1')
        ...
        remove_filter 'Brand Porfolio 1'
  ...
  shared_examples_for 'a user that can view visits details' do
    ...
    scenario 'should be able to export as CSV' do
      ...
      expect(ListExport.last).to have_rows([
        ...
        ['ABSOLUT Vodka', '', '2014-02-01 09:00', '2014-02-01 11:00', '2.00', 'My Place 3',
         'My Place 3, 11 Main St., New York, NY, 12345', 'New York', 'NY', '12345',nil, 'Active', 'Unsent',
        ...
        ['ABSOLUT Vodka', '', '2014-02-01 10:00', '2014-02-01 11:00', '1.00', 'My Place 1',
         'My Place 1, 11 Main St., New York, NY, 12345', 'New York', 'NY', '12345',nil, 'Active', 'Unsent',
    ...
    scenario 'can create a new event' do
      ...
      within visible_modal do
        ...
        select_and_fill_from_datepicker('event_end_date', (today + 1.day).to_s(:slashes))
