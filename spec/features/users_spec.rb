...
feature 'Users', js: true do
  ...
  feature 'User details page', js: true do
    ...
    scenario 'should validate who is not present the role admin' do
      ...
      user = create(:user,
                    first_name: 'Juanito', last_name: 'Mora',
                    role_id: create(:non_admin_role, name: 'Test not admin role', company: company).id,
    ...
    scenario 'allows to assign areas and places to the user' do
      ...
      within '#company_user-places-list' do
        hover_and_click('.hover-item', 'Remove Place')
      end
