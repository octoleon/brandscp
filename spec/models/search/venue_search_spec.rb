    ...
    it 'should include any venue that is part of the campaign scope' do
      ...
      venue_sf1 = create(:venue,
                         place: create(:place, name: 'Place in SF1', city: 'San Francisco',
                                               state: 'CA', country: 'US'),
                         company: company)
      venue_sf1.campaign_ids << campaign.id
      venue_sf1.save
      ...
      venue_sf2 = create(:venue,
                         place: create(:place, name: 'Place in SF1', city: 'San Francisco',
                                               state: 'CA', country: 'US'),
                         company: company)
      venue_sf2.campaign_ids << campaign.id
      venue_sf2.save
      ...
      expect(search(company_id: company.id, campaign: [campaign.id])).to match_array([venue_sf1, venue_sf2])
    end
  end
